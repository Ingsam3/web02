...
<body>
	...
	아이디 : <input type="text" name="login_id" id="iogin_id" size="14" tabindex="1">
	<!-- tabindex: 탭키 눌렀을 때 첫번째 포커스를 가진다 -->
	비밀번호 : <input type="password" name="login_pwd" id="iogin_pwd" size="14" tabindex="2">
